  ...
  if (href) {
    return (
      ...
      >
        ...
        <div className="p-4 sm:p-5 md:p-6 text-left">
          <h4
            className="text-2xl sm:text-2xl font-semibold mb-2 sm:mb-3 text-white"
            style={{ fontSize: "clamp(22px, 2.5vw, 22px)" }}
          >
            {blog.title}
          </h4>
          <p
            className="text-gray-300 text-md md:text-md mb-3 sm:mb-4"
            style={{ fontSize: "clamp(18px, 2.5vw, 16px)" }}
          >
            {blog.excerpt}
          </p>
          <div className="mt-2">
...
export default function ConsciousKarmaSections() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black text-gray-50 font-arsenal overflow-x-hidden">
          ...
          <div className="text-center w-full px-4">
            ...
            >
              ...
              <span className="block md:inline">
                ...
                <span className="block md:inline">
                  <span className="text-[#f59255] md:text-[#fff] font-normal">
                    <FormattedMessage id="hero.title.TO" defaultMessage="TO " />
                  </span>
      ...
      <section className="relative bg-black flex flex-col items-center justify-center px-2 sm:px-6">
        <div className="container mx-auto text-center max-w-5xl">
          <div>
            <SectionSpacer />
          </div>
      ...
      <section className="relative bg-black flex flex-col items-center justify-center px-4 sm:px-6 text-center">
        <div>
          <OptimizedImg
            src={earthConnections}
            alt={intl.formatMessage({ id: "woven.altImage" })}
