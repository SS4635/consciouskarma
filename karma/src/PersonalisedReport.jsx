...
const ConsciousKarmaPage = () => {
 ...
 useEffect(() => {
  ...
  const faqs = [
    ...
    { question: "How many secondary numbers can I add?", answer: "You can include up to three secondary numbers along with your primary number. If you're using more than four numbers, we recommend booking a consultation." },
